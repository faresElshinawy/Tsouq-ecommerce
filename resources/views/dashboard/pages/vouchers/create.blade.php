            ...
            <div class="card-body">
                <form action='{{ route('vouchers.store') }}' method="POST" >
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" value='{{old('code')  }}' class="form-control  @error('code') border-danger @enderror" id="basic-default-code" name="code" placeholder="Voucher Code">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="number" value='{{old('value') }}' class="form-control  @error('value') border-danger @enderror" id="basic-default-value" name="value" placeholder="Voucher Value">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="number" value='{{old('price_limit') }}' class="form-control  @error('price_limit') border-danger @enderror" id="basic-default-price_limit" name="price_limit" placeholder="Price Limit">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="type" class="form-control @error('type') border-danger @enderror" id="basic-default-type">
                                ...
                                <option value="{{str_replace(' ','_',$type)}}" @selected($type == old('type'))>{{$type}}</option>
                                @endforeach
                            </select>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="status" class="form-control @error('status') border-danger @enderror" id="basic-default-status">
                                ...
                                <option value="{{$status_opt}}" @selected($status_opt == old('status'))>{{$status_opt}}</option>
                                @endforeach
                            </select>
                        </div>
                      </div>
