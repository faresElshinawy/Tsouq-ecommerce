        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="m-3 d-flex justify-content-between">
                    <div class="col-3">
                        <input type="text" class="form-control" id="brand-search" placeholder="Search...">
                    </div>
                    @can('brands create')
                    <a class="btn btn-primary text-white" href="{{ route('brands.create') }}">Add New brand</a>
                    @endcan
                </div>
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-sm-10">
                                                @if (File::exists(public_path('uploads/brands/' . $brand->image)) || filter_var($brand->image,FILTER_VALIDATE_URL))
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('brands.edit', ['brand' => $brand->id]) }}"><i
                                                            class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    @endcan

                                                    @can('products all')
                                                    <a class="dropdown-item"
                                                        href="{{ route('brands.products', ['brand' => $brand->id]) }}"><i
                                                            class='bx bx-package'></i> Products</a>
                                                    @endcan
...
@section('js')
    <script>
        $(document).ready(function() {
            $(document).on('keyup', '#brand-search', function(e) {
                e.preventDefault();
                query = this.value;
                $.ajax({
