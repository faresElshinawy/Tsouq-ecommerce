        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="m-3 d-flex justify-content-between">
                    <div class="col-3">
                        <input type="text" class="form-control" id="setting-search" placeholder="Search...">
                    </div>
                </div>
                                ...
                                @foreach ($settings as $setting)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <strong>{{ str_replace('-',' ',$setting->key) }}</strong>
                                        </td>
                                        <td>{{ $setting->value }}</td>
                                        <td>
                                            <div class="dropdown">
...
<script>
    $(document).ready(function(){
        $(document).on('keyup','#setting-search',function(e){
            e.preventDefault();
            query = this.value;
            $.ajax({
