        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="m-3 d-flex justify-content-between">
                    ...
                    @can('category create')
                        <a class="btn btn-primary text-white" href="{{ route('categories.create') }}">Add New category</a>
                    @endcan
                </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @can('products all')
                                                    <a class="dropdown-item"
                                                        href="{{ route('categories.products', ['category' => $category->id]) }}"><i class='bx bx-package'></i> Products</a>
                                                    @endcan
