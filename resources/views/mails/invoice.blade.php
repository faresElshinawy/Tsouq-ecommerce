        ...
        <div class="invoice-details">
            <div class="invoice-details-left">
                ...
                @if ($order->address ?? false)
                    <p><strong>User Phone:</strong> {{ $order->address->phone }}</p>
                    <p><strong>Order Address To:</strong> {{ $order->address->country->name . ', ' . ($order->address->city_spare) . ', ' . $order->address->street . ', ' . $order->address->building_number }}</p>
                @endif
            </div>
            <div class="invoice-details-right">
                <p><strong>Products Count:</strong> {{ $order->items->count() }}</p>
