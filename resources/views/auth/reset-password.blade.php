...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Tsouq</span>
                            </a>
                        </div>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mb-3">
            ...
            @enderror
            <input type="text" class="form-control @error('email') border-danger @enderror" id="email" value="{{old('email') ?? $request->email}}"
